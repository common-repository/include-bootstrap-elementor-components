            ...
            if( $the_query->have_posts() ) {
                ...
                while( $the_query->have_posts() ) {
                    ...
                    <div class="col-md-6 col-xs-12 ebc-blog-margin">
                        ...
                        <figure class="ebc-modern-hover-15-frame-animate">
                            <a id="post-<?php the_ID(); ?>" <?php post_class('modern_hover_image'); ?> href="<?php the_permalink(); ?>">
                                <?php the_post_thumbnail(); ?>
                            </a>
                            <figcaption style="transition: all <?php echo $settings['transtion-time']; ?>s ease; ">	
                                <div class="ebc-post-content" style="transition: <?php echo $settings['transtion-time']; ?>s ease; " >
