...
class EBC_BlogAccordion extends Widget_Base
{
  ...
  {
    return __('Blog Expand', 'ebc-by-motahar');
  }
  ...
  protected function _register_controls()
  {
    ...
    $this->start_controls_section(
      'blog_posts_heading',
      [
        'label' => __('Blog Posts Heading', 'ebc-by-motahar'),
    ...
    $this->start_controls_section(
      ...
      [
        'label' => __('Accordion Wrapper', 'ebc-by-motahar'),
        'tab' => Controls_Manager::TAB_STYLE,
      ]
    );
    ...
    $this->add_control(
      'accordion-height',
      [
        'label' => __('Accordion Height', 'ebc-by-motahar'),
        ...
        'selectors' => [
          '{{WRAPPER}} .ebc-blog-accordion-wrapper .ebc-accordion-wrapper .accordion ' => 'height: {{SIZE}}{{UNIT}};',
          '{{WRAPPER}} .ebc-blog-accordion-wrapper .ebc-accordion-wrapper .accordion ul li' => 'height: {{SIZE}}{{UNIT}};',
          '{{WRAPPER}} .ebc-blog-accordion-wrapper .ebc-accordion-wrapper .accordion ul li .ebc-accordion-content ' => 'height: {{SIZE}}{{UNIT}};',
        ],
      ]
    );
    ...
    $this->add_control(
      ...
      [
        ...
        'type' => Controls_Manager::COLOR,
        'selectors' => [
          '{{WRAPPER}} .ebc-blog-accordion-wrapper .ebc-accordion-wrapper' => 'background-color: {{VALUE}};',
        ],
      ]
    );
    ...
    $this->add_group_control(
      ...
      [
        'name' => 'blog-accordion-border',
        'label' => __('Border', 'ebc-by-motahar'),
        'selector' => '{{WRAPPER}} .ebc-blog-accordion-wrapper .ebc-accordion-wrapper',
      ]
    );
    ...
    $this->add_control(
      ...
      [
        ...
        'selectors' => [
          '{{WRAPPER}} .ebc-blog-accordion-wrapper .ebc-accordion-wrapper' => 'padding: {{SIZE}}{{UNIT}};',
        ],
      ]
    );
    ...
    $this->add_control(
      ...
      [
        ...
        'selectors' => [
          '{{WRAPPER}} .ebc-blog-accordion-wrapper .ebc-accordion-wrapper' => 'margin: {{SIZE}}{{UNIT}};',
        ],
      ]
    );
    ...
    $this->add_control(
      ...
      [
        ...
        'selectors' => [
          '{{WRAPPER}} .ebc-blog-accordion-wrapper .ebc-accordion-wrapper' => 'border-radius: {{SIZE}}{{UNIT}};',
        ],
      ]
    );
    ...
    $this->add_control(
      ...
      [
        'label' => __('Hover Background Color', 'ebc-by-motahar'),
        'type' => Controls_Manager::COLOR,
        'selectors' => [
          '{{WRAPPER}} .ebc-blog-accordion-wrapper .ebc-accordion-wrapper .ebc-accordion-content' => 'background-color: {{VALUE}};',
        ],
      ]
    );
    ...
    $this->add_control(
      ...
      [
        ...
        'selectors' => [
          '{{WRAPPER}} .ebc-blog-accordion-wrapper .ebc-accordion-wrapper li' => 'border-radius: {{SIZE}}{{UNIT}};',
        ],
      ]
    );
    ...
    $this->add_group_control(
      ...
      [
        ...
        'label' => __('Border', 'ebc-by-motahar'),
        'selector' => '{{WRAPPER}} .ebc-blog-accordion-wrapper .ebc-accordion-wrapper li',
      ]
    );
    ...
    $this->add_control(
		...
		[
			'label' => __('Position', 'ebc-by-motahar'),
			'type' => Controls_Manager::SLIDER,
			'range' => [
				'px' => [
					'min' => 0,
			...
			'selectors' => [
					'{{WRAPPER}} .ebc-blog-accordion-wrapper .ebc-accordion-wrapper .ebc-accordion-content' => 'padding-top: {{SIZE}}{{UNIT}};',
				],
		]
	);
    ...
    $this->add_control(
		...
		[
			...
			'selectors' => [
					'{{WRAPPER}} .ebc-blog-accordion-wrapper .ebc-accordion-wrapper .ebc-blog-title h2' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
		]
	);
	...
	$this->add_control(
		...
		[
			...
			'type' => Controls_Manager::COLOR,
			'selectors' => [
					'{{WRAPPER}} .ebc-blog-accordion-wrapper .ebc-accordion-wrapper .ebc-blog-title' => 'text-decoration: none;',
					'{{WRAPPER}} .ebc-blog-accordion-wrapper .ebc-accordion-wrapper .ebc-blog-title h2' => 'color: {{VALUE}};',
				],
      	]
	);
	...
	$this->add_group_control(
		Group_Control_Typography::get_type(),
			[
				...
				'selector' => '{{WRAPPER}} .ebc-blog-accordion-wrapper .ebc-accordion-wrapper .ebc-blog-title h2',
				'scheme' => Schemes\Typography::TYPOGRAPHY_1,
			]
	);
	...
	$this->add_control(
		...
		[
			...
			'type' => Controls_Manager::COLOR,
			'selectors' => [
				'{{WRAPPER}} .ebc-blog-accordion-wrapper .ebc-accordion-wrapper .ebc-post-excerpt p' => 'color: {{VALUE}};',
			],
      	]
	);
	...
	$this->add_control(
		...
		[
			...
			'type' => Controls_Manager::COLOR,
			'selectors' => [
				'{{WRAPPER}} .ebc-blog-accordion-wrapper .ebc-accordion-wrapper .ebc-post-excerpt .ebc-link-readmore' => 'color: {{VALUE}};',
			],
      	]
	);
	...
	$this->add_group_control(
		Group_Control_Typography::get_type(),
			[
				...
				'selector' => '{{WRAPPER}} .ebc-blog-accordion-wrapper .ebc-accordion-wrapper .ebc-post-excerpt p',
				'scheme' => Schemes\Typography::TYPOGRAPHY_1,
			]
	);
  ...
  protected function render()
  {
    ...
    $this->add_render_attribute('wrapper', 'class', 'ebc-blog-wrapper ebc-blog-accordion-wrapper');

?>

    <div <?php echo $this->get_render_attribute_string('wrapper'); ?> style="text-align: <?php echo $settings['blog_content_alingment']; ?>">
      <?php include (EBC_DIR . 'template-parts/blogaccordion/content.php'); ?>
    </div>
