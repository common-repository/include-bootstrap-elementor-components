...
class EBC_BlogFlipRotate extends Widget_Base
{
  ...
  {
    return __('Blog Flip Rotate', 'ebc-by-motahar');
  }
  ...
  protected function _register_controls()
  {
    ...
    $this->add_control(
      ...
      [
        ...
        'type' => Controls_Manager::COLOR,
        'selectors' => [
          '{{WRAPPER}} .ebc-blog-wrapper figcaption' => 'background-color: {{VALUE}};',
        ],
      ]
    );
    ...
    $this->add_control(
      ...
      [
        ...
        'type' => Controls_Manager::COLOR,
        'selectors' => [
          '{{WRAPPER}} .ebc-blog-wrapper figcaption' => 'border-color: {{VALUE}};',
        ],
      ]
    ); 
    ...
    $this->add_control(
      ...
      [
        ...
        'selectors' => [
          '{{WRAPPER}} .ebc-blog-wrapper figcaption' => 'border-left-width: {{SIZE}}{{UNIT}};',
        ],
      ]
    );
    ...
    $this->add_control(
      ...
      [
        ...
        'selectors' => [
          '{{WRAPPER}} .ebc-blog-wrapper figcaption' => 'border-right-width: {{SIZE}}{{UNIT}};',
        ],
      ]
    );
    $this->add_control(
      ...
      [
        ...
        'selectors' => [
          '{{WRAPPER}} .ebc-blog-wrapper figcaption' => 'border-top-width: {{SIZE}}{{UNIT}};',
        ],
      ]
    );
    ...
    $this->add_control(
      ...
      [
        ...
        'selectors' => [
          '{{WRAPPER}} .ebc-blog-wrapper figcaption' => 'border-bottom-width: {{SIZE}}{{UNIT}};',
        ],
      ]
    );
    ...
    $this->add_control(
      ...
      [
        ...
        'selectors' => [
          '{{WRAPPER}} .ebc-blog-wrapper figcaption' => 'border-radius: {{SIZE}}{{UNIT}};',
        ],
      ]
    );
    ...
    $this->add_control(
      ...
      [
        ...
        'selectors' => [
          '{{WRAPPER}} .ebc-blog-wrapper figcaption' => 'padding: {{SIZE}}{{UNIT}};',
        ],
      ]
    );
    ...
    $this->add_control(
		...
		[
			...
			'selectors' => [
					'{{WRAPPER}} .ebc-blog-wrapper .ebc-post-content .ebc-blog-title h1' => 'padding-top: {{SIZE}}{{UNIT}};',
				],
		]
	);
    ...
    $this->add_control(
		...
		[
			...
			'selectors' => [
					'{{WRAPPER}} .ebc-blog-wrapper .ebc-post-content .ebc-post-excerpt' => 'padding-top: {{SIZE}}{{UNIT}};',
				],
		]
	);
  ...
  protected function render()
  {
    ...
    $this->add_render_attribute('wrapper', 'class', 'ebc-blog-wrapper ebc-blogfliprotate');

?>

    <div <?php echo $this->get_render_attribute_string('wrapper'); ?> style="text-align: <?php echo $settings['blog_content_alingment']; ?>">
      <?php 
        if($settings['blog_column_count'] === 'two') {
            include (EBC_DIR . 'template-parts/blogfliprotate/two-column.php');  
        } else if($settings['blog_column_count'] === 'three') { 
            include (EBC_DIR . 'template-parts/blogfliprotate/three-column.php');
        } else {
            include (EBC_DIR . 'template-parts/blogfliprotate/four-column.php'); 
        }
